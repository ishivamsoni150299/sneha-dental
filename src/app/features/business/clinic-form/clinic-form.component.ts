...
export class ClinicFormComponent implements OnInit, OnDestroy {
  ...
  form = this.fb.nonNullable.group({
    ...
    marketplaceExperienceYears: this.fb.control<number | null>(null),
    marketplaceSpeciality: [''],
    marketplaceGender: [''],
    marketplacePaymentMethods: this.fb.nonNullable.control<string[]>([]),
    marketplaceAcceptingNewPatients: [true],
    marketplaceVideoConsultationEnabled: [false],
    marketplaceVideoConsultationFee: this.fb.control<number | null>(null),
  ...
  private patchForm(c: StoredClinic, verification: ProviderVerification | null) {
    ...
    this.form.patchValue({
      ...
      marketplaceExperienceYears: c.marketplaceProfile?.experienceYears ?? null,
      marketplaceSpeciality: c.marketplaceProfile?.speciality ?? '',
      marketplaceGender: c.marketplaceProfile?.gender ?? '',
      ...
      marketplaceVideoConsultationEnabled: c.marketplaceProfile?.videoConsultationEnabled ?? false,
      marketplaceVideoConsultationFee: c.marketplaceProfile?.videoConsultationFee ?? null,
  ...
  private marketplaceFieldsChanged(): boolean {
    return [
      ...
      'marketplaceExperienceYears', 'marketplaceSpeciality', 'marketplaceGender',
      'marketplaceAcceptingNewPatients', 'marketplaceListingImageUrl',
      'marketplaceVideoConsultationEnabled', 'marketplaceVideoConsultationFee',
