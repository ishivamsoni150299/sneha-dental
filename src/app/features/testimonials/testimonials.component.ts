...
export class TestimonialsComponent {
  testimonials = [
    { name: 'Priya M.',    location: 'Pune - Verified Patient',      rating: 5, review: 'I was terrified of dentists all my life. Dr. Sneha made my root canal completely painless. I could not believe how comfortable it was!' },
    ...
    { name: 'Sunita P.',   location: 'Pune - Verified Patient',      rating: 5, review: 'Brought my 7-year-old daughter for her first dental visit. Dr. Sneha made her laugh through the whole checkup. We are regulars now!' },
